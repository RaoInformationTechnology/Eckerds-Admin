...
$sql1 = "SELECT *  FROM  pricecheck WHERE location = 'Wauchula'";
...
$sql2 = "SELECT *  FROM  pricecheck WHERE location = 'Palmetto'";
...
$sql3 = "SELECT *  FROM  pricecheck WHERE location = 'Bradenton'";
...
$sql4 = "SELECT *  FROM  pricecheck WHERE location = 'Apollo Beach'";
...
$sql5 = "SELECT *  FROM  pricecheck WHERE location = 'New Port Beach'";
...
$sql6= "SELECT *  FROM  pricecheck WHERE location = 'New Port Richey'";
...
$sql7 = "SELECT *  FROM  pricecheck WHERE location = 'Lake Jackson'";
...
$sql8 = "SELECT *  FROM  pricecheck WHERE location = 'West Bradenton'";
