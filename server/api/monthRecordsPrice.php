...
$sql1 = "SELECT *  FROM  pricecheck WHERE MONTH(createdAt)  = 01";
...
$sql2 = "SELECT *  FROM  pricecheck WHERE MONTH(createdAt) = 02";
...
$sql3 = "SELECT *  FROM  pricecheck WHERE MONTH(createdAt) = 03";
...
$sql4 = "SELECT *  FROM  pricecheck WHERE MONTH(createdAt) = 04";
...
$sql5 = "SELECT *  FROM  pricecheck WHERE MONTH(createdAt) = 05";
...
$sql6 = "SELECT *  FROM  pricecheck WHERE MONTH(createdAt) = 06";
...
$sql7 = "SELECT *  FROM  pricecheck WHERE MONTH(createdAt) = 07";
...
$sql8 = "SELECT *  FROM  pricecheck WHERE MONTH(createdAt) = 08";
...
$sql9 = "SELECT *  FROM  pricecheck WHERE MONTH(createdAt) = 09";
...
$sql10 = "SELECT *  FROM  pricecheck WHERE MONTH(createdAt) = 10";
...
$sql11 = "SELECT *  FROM  pricecheck WHERE MONTH(createdAt) = 11";
...
$sql12 = "SELECT *  FROM  pricecheck WHERE MONTH(createdAt) = 12";
